    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 *
                 * The codebase itself is git-tracked, not user data, so only
                 * uploaded files (product photos etc., via the public disk)
                 * plus the database dump are backed up — not the whole app.
                 */
                'exclude' => [
                    base_path('vendor'),
