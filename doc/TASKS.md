...
- [ ] **3.8** Category/Unit/Brand Modal CRUD + quick-add "+" পাশে
- [ ] **3.9** Product image upload (`spatie/laravel-medialibrary`)
- [ ] **3.10** Feature test: opening stock একবারের বেশি দেওয়া গেলে reject হয়
...
- [ ] **5.1** `purchases`, `purchase_items` migration+model (status: draft/ordered/received/cancelled)
- [ ] **5.2** `ConfirmPurchaseAction` (StockService + weighted avg_cost recalculation একসাথে)
...
- [ ] **5.6** Feature test: purchase confirm হলে avg_cost সঠিকভাবে recalculate হয়
